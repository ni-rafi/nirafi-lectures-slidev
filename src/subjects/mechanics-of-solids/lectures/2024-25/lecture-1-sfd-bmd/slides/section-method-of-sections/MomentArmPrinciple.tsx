    ...
    <TwoColumnLayout
      ...
      leftContent={
        <>
          ...
          <SlideList
            title="Relative Moment Arm Calculation"
            description="Deriving moment arms for moving cuts in subsequent zones."
            revealMode="each-click"
            items={[
              { 
                revealAt: 1, 
                title: "1. Variable Cuts with Fixed Loads", 
                text: (
                  <span>
                    When cutting at variable position <ClickHighlight at={1} variant="paint">x</ClickHighlight>, the distance from Support A to the cut plane is <ClickHighlight at={1} variant="paint">x</ClickHighlight>. A point load acts at a fixed offset distance <ClickHighlight at={1} variant="paint">d</ClickHighlight>.
                  </span>
                ) 
              },
              { 
                revealAt: 2, 
                title: "2. The Relative Arm (x - d)", 
                text: (
                  <span>
                    The distance from the point load to the moving cut face is the relative distance <ClickHighlight at={2} variant="paint">(x - d)</ClickHighlight>.
                  </span>
                ) 
              },
