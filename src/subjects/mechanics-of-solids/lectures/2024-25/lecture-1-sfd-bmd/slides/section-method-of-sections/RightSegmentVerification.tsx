    ...
    <TwoColumnLayout
      ...
      leftContent={
        <>
          ...
          <SlideList
            ...
            items={[
              { revealAt: 1, title: "1. Complementary Conventions", text: "Isolate the right side. Place an upward V and a clockwise M on the left-facing cut face." },
              ...
              { revealAt: 3, title: "3. Choice is Mathematical Convenience", text: "Both left and right FBDs yield the exact same internal forces. Pick the simpler FBD with fewer loads." }
            ]}
          />
        </>
      }
      rightContent={
        <div className="bg-muted/30 rounded-xl p-4 flex flex-col justify-between h-full min-h-[300px] border border-border/50 text-left">
          <span className="text-[9px] font-bold text-muted-foreground uppercase tracking-widest block mb-0.5">Right Free-Body Diagram</span>
