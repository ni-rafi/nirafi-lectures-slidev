...
export const ZoneOneFBD: React.FC = () => {
  return (
    <FullWidthLayout title={<span>Constructing Equation 1 (Zone 1)</span>}>
      <AnalyticalProblemSolverVisualizer beam={beamConfig} phase="sections" stepIndex={1} />
      
      {/* 5-step reveals (Cut -> Shear Arm/Label -> Shear Card -> Moment Arc/Label -> Moment Card) */}
