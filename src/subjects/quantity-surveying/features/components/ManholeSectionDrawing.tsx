  ...
  return (
    <div className={containerClasses}>
      ...
      >
        ...
        <line x1={innerLeft + 1} y1={gY} x2={innerLeft + 1} y2={bottomY} stroke="var(--chart-1, #3b82f6)" strokeWidth="1.5" className="transition-all duration-300" />
        <line x1={innerRight - 1} y1={gY} x2={innerRight - 1} y2={bottomY} stroke="var(--chart-1, #3b82f6)" strokeWidth="1.5" className="transition-all duration-300" />
        ...
        {showAnnotation && (
          <g className="font-mono text-[9px] fill-muted-foreground font-bold">
            ...
            <text x="300" y="34" className="fill-chart-3 text-[7.5px] font-mono">Gross: {outerL.toFixed(3)}x{outerW.toFixed(3)}m</text>
            <text x="300" y="44" className="fill-chart-3 text-[7.5px] font-mono font-bold">Net Vol = {wallVol.toFixed(3)} m³</text>
            
            <text x="298" y="62" className="fill-foreground text-[8px] font-bold">Internal Plaster (1:3):</text>
            <text x="300" y="74" className="fill-chart-1 text-[7.5px] font-mono">2 × (L + W) × D</text>
            <text x="300" y="84" className="fill-chart-1 text-[7.5px] font-mono font-bold">Area = {plasterArea.toFixed(2)} m²</text>
          </g>
        )}
      </svg>
    </div>
